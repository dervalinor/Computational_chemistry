...
Este repositorio es un espacio para la experimentación y el aprendizaje. No pretendemos desarrollar soluciones comerciales o académicas, sino explorar conceptos y métodos en un entorno experimental. Aquí encontrarás scripts, notebooks y ejemplos que hemos creado para entender mejor la química desde una perspectiva computacional.
